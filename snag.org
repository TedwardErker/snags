  ...
  registerDoParallel(cl)
      ...
      features <- foreach (tile.dir = tile.dirs,
                           .packages = c("raster","stringr","randomForest")) %dopar% {
                               ...
                               pred.r <- raster::predict(st, mod, filename = paste0(tile.dir, "predicted.tif", overwrite = T, datatype = "INT1U"))
...
#+RESULTS:
: Error in { : 
:   task 1 failed - "no applicable method for 'predict' applied to an object of class "randomForest""
