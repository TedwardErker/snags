...
#+begin_src R
      ...
      r.tocrop <- lapply(list.files(f.dir, full.names = T, pattern = ".*m_4409047_ne_15_1_20130701_masked_.*"), function(f) {
          r <- raster(f)
          crop(r, extent(r, 724, 7750, 1, 5850), filename = f, overwrite = T)
  })
#7027
#7750
#+end_src
...
:   `/home/erker/snag/data/NAIPImages/Sandhill2013/m_4409047_ne_15_1_20130701_masked_livetrees.tif' does not exist in the file system,
...
#+begin_src R
  ...
  lapply(imgs[2], function(img) {
      ...
      for (i = 1:divide) {
          ...
          save(df,file=paste0(f.dir,img, "_",i,"_train.RData"))
      }
    
      list.files(f.dir, pattern = paste0(".*",img, "_[0-9]_train.RData"))
          cbind
      saveRDS(df, paste0(f.dir,img, "_model_building_df.rds"))
