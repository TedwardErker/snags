...
#+begin_src R
top <- arrange(data.frame(importance(mod_all), name = row.names(importance(mod_all))), -MeanDecreaseGini) %>% head(80)
top
#+end_src
...
1         1640.1440                            X_ratio.nir
2         1533.7017    X_ratio.nir_windowcircle.2_fun.mean
3         1443.6140    X_ratio.nir_windowcircle.1_fun.mean
4         1090.3642    X_ratio.nir_windowcircle.4_fun.mean
5         1065.6507     X_ratio.nir_windowcircle.1_fun.max
6         1033.2914    X_ratio.blue_windowcircle.1_fun.max
7          999.3715     X_ratio.nir_windowcircle.1_fun.min
8          987.8498   X_ratio.blue_windowcircle.2_fun.mean
9          952.8966    X_ratio.blue_windowcircle.2_fun.max
10         941.2373   X_ratio.blue_windowcircle.1_fun.mean
11         893.0549         X_ndvi_windowcircle.2_fun.mean
12         828.0100                                  X_nir
13         809.4786                           X_ratio.blue
14         795.5489         X_ndvi_windowcircle.1_fun.mean
15         717.1698     X_ratio.nir_windowcircle.2_fun.max
16         670.7316   X_ratio.blue_windowcircle.4_fun.mean
17         643.2662    X_ratio.nir_windowcircle.8_fun.mean
18         598.0511          X_ndvi_windowcircle.1_fun.max
19         587.0403        X_green_windowcircle.1_fun.mean
20         566.2538    X_ratio.blue_windowcircle.1_fun.min
21         544.1973                                X_green
22         538.5823          X_nir_windowcircle.1_fun.mean
23         529.6685                                 X_ndvi
24         528.0749          X_nir_windowcircle.2_fun.mean
25         499.9986   X_ratio.blue_windowcircle.8_fun.mean
26         497.7599           X_nir_windowcircle.2_fun.min
27         494.7178           X_nir_windowcircle.1_fun.min
28         483.9616     X_ratio.nir_windowcircle.2_fun.min
29         457.0824        X_green_windowcircle.2_fun.mean
30         444.5506  X_ratio.green_windowcircle.8_fun.mean
31         436.7583         X_green_windowcircle.1_fun.max
32         410.3372    X_ratio.blue_windowcircle.2_fun.min
33         405.1898          X_ndvi_windowcircle.2_fun.max
34         398.4352         X_ndvi_windowcircle.4_fun.mean
35         398.0578          X_ndvi_windowcircle.1_fun.min
36         396.9595         X_ndvi_windowcircle.8_fun.mean
37         378.6807                          X_ratio.green
38         378.3171  X_ratio.green_windowcircle.1_fun.mean
39         373.4306 X_ratio.green_windowcircle.11_fun.mean
40         354.3631  X_ratio.blue_windowcircle.11_fun.mean
41         343.0435          X_nir_windowcircle.4_fun.mean
42         339.1149           X_nir_windowcircle.1_fun.max
43         326.4274         X_nir_windowcircle.11_fun.mean
44         322.3859   X_ratio.nir_windowcircle.11_fun.mean
45         317.2545     X_ratio.red_windowcircle.1_fun.min
46         306.5528          X_nir_windowcircle.8_fun.mean
47         286.8324    X_ratio.blue_windowcircle.4_fun.max
48         243.6691        X_green_windowcircle.4_fun.mean
49         234.6206         X_green_windowcircle.2_fun.max
50         229.9857  X_ratio.green_windowcircle.2_fun.mean
51         225.7472   X_ratio.green_windowcircle.1_fun.max
52         215.9831           X_nir_windowcircle.4_fun.min
53         205.3678         X_green_windowcircle.1_fun.min
54         204.4184       X_green_windowcircle.11_fun.mean
55         204.0322    X_ratio.red_windowcircle.1_fun.mean
56         183.6173    X_ratio.red_windowcircle.4_fun.mean
57         164.1707        X_green_windowcircle.8_fun.mean
58         145.0765        X_ndvi_windowcircle.11_fun.mean
59         144.3517           X_red_windowcircle.1_fun.max
60         137.0987                                 X_blue
61         135.7730   X_ratio.green_windowcircle.2_fun.max
62         135.4892    X_ratio.red_windowcircle.2_fun.mean
63         135.2212          X_red_windowcircle.1_fun.mean
64         131.5687     X_ratio.nir_windowcircle.4_fun.max
65         131.2847          X_ndvi_windowcircle.2_fun.min
66         130.7681          X_red_windowcircle.2_fun.mean
67         128.5292     X_ratio.red_windowcircle.1_fun.max
68         118.1757           X_red_windowcircle.8_fun.min
69         117.2487   X_ratio.red_windowcircle.11_fun.mean
70         115.9708           X_nir_windowcircle.8_fun.min
71         114.9742                                  X_red
72         114.2766         X_green_windowcircle.8_fun.min
73         112.5400          X_blue_windowcircle.1_fun.max
74         111.3640         X_blue_windowcircle.1_fun.mean
75         111.3579          X_nir_windowcircle.11_fun.min
76         110.6782     X_ratio.nir_windowcircle.4_fun.min
77         107.9479        X_green_windowcircle.11_fun.min
78         107.2889    X_ratio.red_windowcircle.8_fun.mean
79         104.3983                            X_ratio.red
80         102.2546           X_nir_windowcircle.2_fun.max
#+end_example
...
#+begin_src R
  ...
  cropped.images <- lapply(6:length(projs), function(i) {             # skipping the black river, because they are already trimmed
      ...
      if(grepl(".*zone=15.*", projs[i])) {
          ci <- lapply(1:length(bufs$utm15), function(j) {
              ...
              t.out.path <- paste0(tools::file_path_sans_ext(image.files[i]),"_trimmed_",j,".tif")
              if(gIntersects(poly.extents.merged[i,], bufs$utm15[j,])) {
                  ...
                  m1 <- trim(m1, filename = m.out.path, overwrite = T)
              }
          })
      }
      ...
      if(grepl(".*zone=16.*", projs[i])) {
          ci <- lapply(1:length(bufs$utm16), function(j) {
              ...
              if(gIntersects(poly.extents.merged[i,], bufs$utm16[j,])) {
                  ...
                  m1 <- trim(mask(c1, bufs$utm16[j,]), filename = m.out.path, overwrite = T)
              }
          })
      }
...
#+RESULTS:
#+begin_example
Error in r - padding : non-numeric argument to binary operator
